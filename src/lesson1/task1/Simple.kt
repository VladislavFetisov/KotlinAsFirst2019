...
fun angleInRadian(deg: Int, min: Int, sec: Int): Double =
    deg * PI / 180.0 + min * PI / (180 * 60.0) + sec * PI / (180 * 3600.0)
 ...
 */
fun trackLength(x1: Double, y1: Double, x2: Double, y2: Double): Double = ((x2 - x1).pow(2) + (y2 - y1).pow(2)).pow(0.5)
